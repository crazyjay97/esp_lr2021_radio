...
#define APP_IMAGE_POST_QUEUE_LENGTH     2U
#define APP_IMAGE_POST_TASK_STACK_BYTES 16384U
#define APP_IMAGE_POST_TASK_PRIORITY    1
#define APP_IMAGE_POST_TASK_CORE        1
